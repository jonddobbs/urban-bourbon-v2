        ...
        <tr>
          <td style="padding:40px 0;">
            ...
            <p style="margin:0 0 24px;font-family:Arial,sans-serif;font-size:15px;color:rgba(255,255,255,0.6);line-height:1.7;">
              Thanks for stopping by Cwmcarn. Here's your 10% off your first bag.
            </p>
            <table cellpadding="0" cellspacing="0" style="margin:0 0 32px;border:1px solid #39FF14;background:rgba(57,255,20,0.04);">
              <tr><td style="padding:18px 28px;">
                <p style="margin:0;font-family:Arial,sans-serif;font-size:28px;font-weight:900;letter-spacing:4px;color:#39FF14;">
                  ${CODE}
                </p>
              </td></tr>
            </table>
        ...
        <tr>
          <td style="padding-top:32px;border-top:1px solid #1a1a1a;">
            ...
            <p style="margin:0;font-family:Arial,sans-serif;font-size:11px;color:rgba(255,255,255,0.15);">
              You're receiving this because you signed up at urbanbourbon.co.uk/qr.
            </p>
          </td>
        </tr>
...
export async function handler(event) {
  ...
  try {
    ...
    console.error('qr-signup function error:', err.message)
    return {
      statusCode: 500,
